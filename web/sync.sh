...
rsync --no-links -avzhe "ssh -i ~/Downloads/slocum_server.pem" ./public_html/js/ ubuntu@52.5.75.36:/ebs/var/www/ensembleweather/public_html/js
scp -i ~/Downloads/slocum_server.pem ./public_html/index.html ubuntu@52.5.75.36:/ebs/var/www/ensembleweather/public_html/
